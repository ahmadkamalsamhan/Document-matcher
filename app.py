...
if uploaded_files:
    ...
    if len(selected_files) >= 2:
        ...
        # -----------------------------
        st.subheader("Select Columns to Match (from first 2 selected files)")
        ...
        cols1 = st.multiselect(f"Select columns from {selected_files[0].name}", df1.columns)
        cols2 = st.multiselect(f"Select columns from {selected_files[1].name}", df2.columns)
